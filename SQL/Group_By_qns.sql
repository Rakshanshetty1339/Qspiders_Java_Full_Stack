...
-- 3. WRITE A QUERY TO DISPLAY THE DEPARTMENT NUMBER WHICH HAS MORE THAN 2 EMPLOYEES AND THE TOTAL AMOUNT REQUIRED TO PAY THE MONTHLY SALARIES OF ALL 
--    THE EMPLOYEES IN THAT DEPARTMENT SHOULD BE MORE THAN 9000.

-- 4. WRITE A QUERY TO DISPLAY NUMBER OF EMPLOYEES WORKING IN EACH DEPARTMENT AND ITS’ AVERAGE SALARY BY EXCLUDING ALL THE EMPLOYEES WHOSE SALARY IS
--    LESS THAN THEIR COMMISSION.
...
-- 8. WRITE A QUERY TO DISPLAY THE NUMBER OF EMPLOYEES ONLY IF THEY ARE WORKING AS MANAGER OR ANALYST AND THEIR ANNUAL SAL SHOULD END WITH A ZERO
--    IN EACH DEPARTMENT.
...
--19. WAQTD NUMBER OF EMPLOYEES REPORTING TO 7839 IN EACH DEPT19.
